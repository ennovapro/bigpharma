	...
	<body class="menubar-hoverable header-fixed ">
        <div style="height: 300px; background-color: #83d2bd;">
            <div id="header-container" style="padding-left: 12%; padding-right: 12%;">
                <h1 style="color: #ffffff; margin-top: 0px; margin-bottom: 0px; padding-top: 36px; font-weight: 300;"> Patient- Peter Gregory <br/> Study- Alercron Acne Cream  </h1>
...
<script src="public/backend/cms/report/js/summaryUserChart.js"></script>
